...
public class BalanceSheetsModel extends NotificationListenerModel {
	...
	public BalanceSheetDTO getHouseholdNationalAccountsBalanceSheet() {
		BalanceSheetDTO householdNationalAccountsBalanceSheet = new BalanceSheetDTO(
				this.referenceCurrency);
		for (BalanceSheetDTO balanceSheet : this.householdBalanceSheets
				.values())
	...
	public BalanceSheetDTO getFactoryNationalAccountsBalanceSheet(
			GoodType goodType) {
		BalanceSheetDTO factoryNationalAccountsBalanceSheet = new BalanceSheetDTO(
				this.referenceCurrency);
		for (BalanceSheetDTO balanceSheet : this.factoryBalanceSheets.get(
				goodType).values())
			copyBalanceSheetValues(balanceSheet,
	...
	public BalanceSheetDTO getTraderNationalAccountsBalanceSheet() {
		BalanceSheetDTO traderNationalAccountsBalanceSheet = new BalanceSheetDTO(
				this.referenceCurrency);
		for (BalanceSheetDTO balanceSheet : this.traderBalanceSheets.values())
			copyBalanceSheetValues(balanceSheet,
	...
	public BalanceSheetDTO getCreditBankNationalAccountsBalanceSheet() {
		BalanceSheetDTO creditBankNationalAccountsBalanceSheet = new BalanceSheetDTO(
				this.referenceCurrency);
		for (BalanceSheetDTO balanceSheet : this.creditBankBalanceSheets
				.values())
			copyBalanceSheetValues(balanceSheet,
	...
	public BalanceSheetDTO getCentralBankNationalAccountsBalanceSheet() {
		BalanceSheetDTO centralBankNationalAccountsBalanceSheet = new BalanceSheetDTO(
				this.referenceCurrency);
	...
	public BalanceSheetDTO getStateNationalAccountsBalanceSheet() {
		BalanceSheetDTO stateNationalAccountsBalanceSheet = new BalanceSheetDTO(
				this.referenceCurrency);
	...
	public BalanceSheetDTO getNationalAccountsBalanceSheet() {
		BalanceSheetDTO nationalAccountsBalanceSheet = new BalanceSheetDTO(
				this.referenceCurrency);
	...
	public Map<Class<? extends Agent>, BalanceSheetDTO> getNationalAccountsBalanceSheets() {
		Map<Class<? extends Agent>, BalanceSheetDTO> nationalAccountsBalanceSheets = new HashMap<Class<? extends Agent>, BalanceSheetDTO>();
	...
	private void copyBalanceSheetValues(BalanceSheetDTO from, BalanceSheetDTO to) {
		if (from == null)
			return;
